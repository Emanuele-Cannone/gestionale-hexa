                ...
                <div>
                    ...
                    <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                            <li>
                                <a href="{{ route('users.create') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Nuovo Utente</a>
                            </li>
                            <li>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('users.edit', $user->id)}} ">
                                        <button class="focus:outline-none text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                                            {{ __('common.edit') }}
                                        </button>
                                    </a>
{{--                                    <button--}}
{{--                                        data-modal-target="deleteRoleModal"--}}
{{--                                        data-modal-toggle="deleteRoleModal"--}}
{{--                                        x-on:click="$dispatch('delete-rolemodal', {'id': '{{$role->id}}'})"--}}
...
{{--        <div--}}
{{--            x-data="{'id' : ''}"--}}
{{--            @delete-rolemodal.window="id = $event.detail.id"--}}
{{--        >--}}
{{--            <!-- Delete Question Modal -->--}}
{{--            <div id="deleteRoleModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">--}}
{{--                <div class="relative w-full max-w-2xl max-h-full">--}}
{{--                    <!-- Modal content -->--}}
{{--                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">--}}
{{--                        <form--}}
{{--                            x-bind:action="'{{ route('roles.destroy', '') }}' + '/' + id"--}}
{{--                            method="post"--}}
{{--                        >--}}
{{--                            @csrf--}}
{{--                            @method('DELETE')--}}
...
{{--                                    {{ __('rolePermission.delete_role') }}--}}
{{--                                </h3>--}}
{{--                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="deleteRoleModal">--}}
...
{{--                            </div>--}}
{{--                            <!-- Modal body -->--}}
{{--                            <div class="p-6 space-y-6 text-md text-gray-500 dark:text-gray-300">--}}
{{--                                {{ __('rolePermission.warning_message') }}--}}
{{--                            </div>--}}
{{--                            <!-- Modal footer -->--}}
{{--                            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">--}}
{{--                                <button data-modal-hide="deleteRoleModal" type="submit" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">--}}
{{--                                    {{ __('common.delete') }}--}}
{{--                                    <i class="fa-regular fa-trash-can"></i>--}}
{{--                                </button>--}}
{{--                                <button data-modal-hide="deleteRoleModal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">{{ __('common.cancel') }}</button>--}}
{{--                            </div>--}}
{{--                        </form>--}}
