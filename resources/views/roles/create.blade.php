            ...
            <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 sm:mb-0">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('roles.create') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ __('rolePermission.new_role') }}</a>
                    </div>
                </li>
            </ol>
        </nav>
